import './Footer.css'
import enamad from "../header/pub/enamad.png"
import etehadiye from "../header/pub/1.jpg"
import apps from "../header/pub/apps.jpg"
        ...
        <div className='footer'>
            <div className='up-side'>
                <p className='upside-desc'>
                    <span style={{ fontWeight: 'bold' }}>بازار، نخستین و پرمخاطب‌ترین فروشگاه ایرانی برنامه‌ها و بازی‌های موبایلی دنیای اندروید</span>
                    <br />
                ...
                <div className='upside-left'>
                    ...
                    <div className='downlod-bazaar' >
                        <span style={{ fontWeight: 'bold' }}>دانلود اپلیکیشن بازار</span>
                        <br />
                        <span style={{ fontSize: '12px' }}>پرمخاطب‌ترین اپ‌استور (اندروید) فارسی‌زبانان</span>

                        <button className='download-android'> نسخه اندروید</button>
                        <button className='download-android'> نسخه اندروید TV</button>
                    </div>
            ...
            <div className='middle-side'>
                <div className='footer-division'>
                    <h6>نصب بازار</h6>
                    <h6>بازی اندروید</h6>
                    <h6>برنامه اندروید</h6>
                </div>

                <div className='footer-division'>
                    <h6>توسعه دهندگان بازار</h6>
                    <h6>فرصت های شغلی</h6>
                    <h6>نشان دریافت از بازار</h6>
                </div>
                ...
                <div className='footer-division'>
                    <h6>بلاگ بازار</h6>
                    <h6>خبرها و بیانیه های بازار</h6>
                    <h6>بلاگ فنی بازار</h6>
                </div>

                <div className='footer-division'>
                    <h6>تبلیغات در بازار</h6>
                    <h6>درباره ما</h6>
                    <h6>تماس با ما</h6>
                </div>

                <div className='footer-division'>
                    <img src={enamad} alt="" className='logo'/>
                    <img src={etehadiye} alt=""  className='logo'/>
                </div>
            </div>
